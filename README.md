...
# Project 3 of Udacity Deep RL Learning Course: Collaboration and Competition

### Introduction

We're solving the [Tennis](https://github.com/Unity-Technologies/ml-agents/blob/master/docs/Learning-Environment-Examples.md#tennis) environment from Unity!  
...
2. Unzip the file you just downloaded and note the path
...
```
python tennis.py --env_path=<path to env> --save_path=<name of folder to save results to>
```
